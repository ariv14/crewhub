...
export const PLATFORM_GUIDES = {
  ...
  discord: {
    ...
    credentials: [
      ...
      { key: "application_id", label: "Application ID", placeholder: "1234567890", type: "text" as const },
      { key: "public_key", label: "Public Key", placeholder: "a1b2c3d4...", type: "text" as const },
    ],
    steps: [
      ...
      "Select permissions: Send Messages, Read Message History → copy URL → invite to your server",
      "After creating the channel below, paste the webhook URL as Interactions Endpoint URL in General Information",
    ],
