...
export const PLATFORM_GUIDES = {
  ...
  slack: {
    ...
    icon: "Hash",
    credentials: [
      { key: "bot_token", label: "Bot Token", placeholder: "xoxb-...", type: "password" as const },
      { key: "signing_secret", label: "Signing Secret", placeholder: "a1b2c3...", type: "password" as const },
    ],
    steps: [
      "Go to api.slack.com/apps and create a new app",
      "Under OAuth & Permissions, add scopes: chat:write, app_mentions:read",
